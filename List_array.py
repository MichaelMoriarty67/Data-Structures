...
class List:
    ...
    def clean(self):
        ...
        for i in range(len(self._values)):
            if not self._values[i] in cln_lst:
                cln_lst.append(self._values[i])

        self._values = cln_lst
    ...
    def insert(self, i, value):
        ...
        if self._is_valid_index(i):
            self._values += [""]
            if i < 0:
                i = len(self._values) - 1 + i

            for j in range(len(self._values) - 2, i - 1, -1):
            ...
            self._values += [""]
            if i < 0:
                for k in range(len(self._values) - 2, -1, -1):
                    self._values[k + 1] = self._values[k]
                self._values[0] = deepcopy(value)
            else:
                self._values[len(self._values) - 1] = deepcopy(value)
    ...
    def intersection(self, source1, source2):
        ...
        for i in range(len(source1._values)):
            if source1._values[i] in source2._values and not source1._values[i] in add_lst:
                add_lst.append(source1._values[i])
    ...
    def split(self):
        ...
        if len(self._values) % 2 == 0:
            ...
            mid = len(self._values) / 2 + 0.5 - 1

        i = 0
        while len(self._values) != 0:
            if i <= mid:
                target1._values.append(self._values[0])
                del self._values[0]
            else:
                target2._values.append(self._values[0])
                del self._values[0]
            i += 1
    ...
    def union(self, source1, source2):
        ...
        if len(source1._values) > len(source2._values):
            len_use = len(source1._values)

        else:
            len_use = len(source2._values)

        for i in range(len_use):
            if i < len(source1._values):
                if not source1._values[i] in self._values:
                    self._values.append(source1._values[i])
            if i < len(source2._values):

        ...
        while i < len(source1._values) or j < len(source2._values):
            if i < len(source1._values):
                if not source1._values[i] in self._values:
                    if j >= len(source2._values) or source1._values[i] <= source2._values[j]:
                        self._values.append(source1._values[i])
                        i += 1
                else:
                    i += 1
            ...
            if j < len(source2._values):
                if not source2._values[j] in self._values:
                    if i >= len(source1._values) or source2._values[j] <= source1._values[i]:
